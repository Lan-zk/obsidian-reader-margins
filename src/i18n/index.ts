...
const STRINGS: Record<ResolvedLanguage, Record<string, string>> = {
  en: {
    ...
    "settings.popoverGrace.desc": "How long a popover card stays open after the pointer leaves the mark, so you can move into it. Any positive value in ms (default 180).",
    "color.label": "Color",
    "color.add": "Add color",
    "color.delete": "Delete",
  ...
  zh: {
    ...
    "settings.popoverGrace.desc": "鼠标离开标记后，气泡卡片保留多久才消失，方便你把鼠标移进去。任意正数毫秒（默认 180）。",
    "color.label": "颜色",
    "color.add": "添加颜色",
    "color.delete": "删除",
    "color.max": "最多 6 个颜色",
